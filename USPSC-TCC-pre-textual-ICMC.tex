...
\titulo{Sistemas de Recomendação: Uma Abordagem Sobre Jogos de Tabuleiro Modernos}
\titleabstract{Recommendation Systems: A Approach On Modern Board Games}
...
\autor{Isabelly de Almeida Silva}
\autorficha{Silva, Isabelly de Almeida}
\autorabr{SILVA, I.}
...
%\orientadorcorpoficha{orientador Adriano Kamimura Suzuki}
\orientadorficha{Suzuki, Adriano Kamimura, orient}
